...
const AddProduct = () => {
    const handleAddProduct = (event) => {
        ...
        fetch("https://luxury-car-self.vercel.app/productsData", {
            method: 'POST',
            headers: {
            ...
            <div className="max-w-screen-xl mx-auto px-8 md:px-16 my-10" >
                ...
                <div className="bg-[#F3F3F3] p-6  my-5" >
                    ...
                    <form onSubmit={handleAddProduct} >
                        ...
                        {/* submit button */}
                        <div className="my-5" >
                            <input className="bg-[#ff5a25] w-full rounded-sm p-2 text-white font-simibold text-xl cursor-pointer" type="submit" value="Add Product" />
                        </div>
                    </form>
